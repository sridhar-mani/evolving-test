export default {
  // NOTE: markdown, javascript, and typescript use the opentui built-in parsers.
  // When adding queries from nvim-treesitter, include query dependencies (e.g. `; inherits: ecma`)
  // and watch for breaking changes incompatible with the web-tree-sitter parser.
  parsers: [
    {
      filetype: "python",
